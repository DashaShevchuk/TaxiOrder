...
public class ClientSignInActivity extends AppCompatActivity {
    ...
    private static final String TAG = "ClientSignInActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            startActivity(new Intent(ClientSignInActivity.this, ClientMapsActivity.class));
        }
                            ...
                            new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(ClientSignInActivity.this, "Authentication failed.",
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Log.w(TAG, "createUserWithEmail:failure",
                                                task.getException());
                                        Toast.makeText(ClientSignInActivity.this,
